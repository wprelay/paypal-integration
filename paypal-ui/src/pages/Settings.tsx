  ...
  const saveSettings = (e: any) => {
    ...
    if (settings.payment_via == "latest") {
      ...
      if (settings.client_secret == "") {
        setErrors((prevErrors: any) => ({
          ...prevErrors,
          client_secret: ["Client Secret key is required"],
        }));
      }
  ...
  return (
    <div className="wrp-py-2">
      <div className="wrp-flex wrp-justify-between wrp-gap-3 wrp-items-center wrp-m-4">
        <div>
          <span className="wrp-text-xl wrp-leading-5 wrp-font-bold">
            {" "}
            Settings
          </span>
        ...
        <CardContent className="!wrp-p-0">
          {loading ? (
            ...
            <div className="wrp-w-full wrp-flex wrp-flex-col">
              <div className="wrp-flex wrp-flex-row wrp-py-10 wrp-border-b-1 wrp-rounded wrp-px-6 wrp-gap-5">
                <div className="wrp-flex-1 wrp-flex wrp-flex-col wrp-gap-2">
                  <h3 className="wrp-text-4 wrp-font-bold wrp-leading-5">
                    Sandbox Mode
                  </h3>
                  <p className="wrp-text-sm wrp-text-grayprimary">
                  ...
                  <div className="wrp-w-full wrp-flex wrp-flex-col">
                    <div className="wrp-flex wrp-flex-row wrp-py-10 wrp-border-b-1 wrp-rounded wrp-px-6 wrp-gap-5">
                      ...
                      <div className="wrp-flex-1 wrp-flex-row wrp-gap-1">
                        ...
                        <p className=" wrp-text-xs wrp-text-destructive wrp-pt-1.5">
                  ...
                  <div className="wrp-w-full wrp-flex wrp-flex-col">
                    <div className="wrp-flex wrp-flex-row wrp-py-10 wrp-border-b-1 wrp-rounded wrp-px-6 wrp-gap-5">
                      <div className="wrp-flex-1 wrp-flex wrp-flex-col wrp-gap-2">
                        ...
                        <p className="wrp-text-sm wrp-text-grayprimary">
                          Configure webhooks to notify your app when certain
                          events occur. To configure a webhook, define your
                          webhook listener URL and a list of events for which to
                          listen
                        </p>
                      </div>
                      <div className="wrp-flex-1 wrp-flex-row wrp-gap-1">
                        <div className="wrp-flex wrp-justify-start wrp-items-center wrp-gap-2 wrp-w-full">
                          <div>
                            <span className="wrp-text-sm">
                          ...
                          <Popover>
                            <PopoverTrigger className="wrp-flex ">
                              <i
                                ...
                                className="wpr wpr-copy lg:wrp-text-lg wrp-text-4 wrp-cursor-pointer wrp-border wrp-rounded-md wrp-p-2"
                              ></i>
                            </PopoverTrigger>
                            <PopoverContent
                              align="start"
                            ...
                            >
                              <p className="wrp-flex wrp-justify-center wrp-items-center">
                                Copied
                              </p>
                            </PopoverContent>
                          </Popover>
                  ...
                  <div className="wrp-w-full wrp-flex wrp-flex-col">
                    <div className="wrp-flex wrp-flex-row wrp-py-10 wrp-border-b-1 wrp-rounded wrp-px-6 wrp-gap-5">
                      <div className="wrp-flex-1 wrp-flex wrp-flex-col wrp-gap-2">
                        ...
                        <p className="wrp-text-sm wrp-text-grayprimary">
                          If you are using an API signature and not an API
                          certificate, specify the API signature associated with
                          the API username
                        </p>
                      </div>
                      <div className="wrp-flex-1 wrp-flex-row wrp-gap-1">
                        ...
                        <p className=" wrp-text-xs wrp-text-destructive wrp-pt-1.5">
                          {errors?.signature ? errors.signature[0] : ""}
                        </p>
                      </div>
                    </div>
                    <div className="wrp-w-full wrp-flex wrp-flex-col">
                      <div className="wrp-flex wrp-flex-row wrp-py-10 wrp-border-b-1 wrp-rounded wrp-px-6 wrp-gap-5">
                        <div className="wrp-flex-1 wrp-flex wrp-flex-col wrp-gap-2">
                          ...
                          <p className="wrp-text-sm wrp-text-grayprimary">
                            Instant Payment Notification (IPN) is a message
                            service that automatically notifies merchants of
                            events related to PayPal transactions
                          </p>
                        </div>
                        <div className="wrp-flex-1 wrp-flex-row wrp-gap-1">
                          <div className="wrp-flex wrp-justify-start wrp-gap-2 wrp-w-full wrp-items-center">
                            <div>
                              <span className="wrp-text-sm">
                                {settings.ipn_notification_url}
                              </span>
                            </div>
                            <Popover>
                              <PopoverTrigger className="wrp-flex ">
