...
export const BatchPayoutItem = () => {
  ...
  return (
    <div className="wrp-py-2">
      <div className="wrp-flex wrp-justify-between wrp-my-4 wrp-mx-5">
        <div className="wrp-flex wrp-justify-between lg:wrp-gap-8 wrp-items-center md:wrp-gap-8 wrp-gap-4">
          <span className="wrp-flex wrp-gap-2 wrp-items-center  ">
            <span className="lg:wrp-text-xl md:wrp-text-lg wrp-text-sm wrp-text-primary wrp-font-bold">
              Payout Items
            </span>
          </span>
        </div>
      ...
      {!loading ? (
          ...
          {searched && payoutItems?.batch_payout_items?.length == 0 ? (
            <div className="wrp-flex wrp-items-center wrp-flex-col wrp-justify-center wrp-text-center wrp-h-full">
              <div className="wrp-mx-auto wrp-my-auto wrp-flex wrp-flex-col wrp-gap-5 wrp-p-5">
                <div>
                  <i className="wpr wpr-list-empty wrp-text-6xl "></i>
                </div>
                <div>
                  <span className="wrp-text-lg wrp-font-bold">
                    The sale detail you are looking for is not found
                  </span>
                </div>
                <div>
                  <p className="wrp-text-sm ">
              ...
              <div className="wrp-h-full">
                <div className="wrp-flex wrp-flex-col wrp-gap-4">
                  <div className="wrp-flex wrp-justify-between wrp-mt-5 wrp-w-full wrp-px-4">
                    <div className=" wrp-text-grayprimary wrp-font-bold xl:wrp-text-xs md:wrp-text-2.5 wrp-w-1/4 wrp-text-2.5 wrp-uppercase">
                      Paypal Email
                    </div>
                    <div className=" wrp-text-grayprimary wrp-font-bold xl:wrp-text-xs md:wrp-text-2.5 wrp-w-1/6 wrp-text-2.5 wrp-uppercase">
                      Amount
                    </div>
                    <div className=" wrp-text-grayprimary wrp-font-bold xl:wrp-text-xs md:wrp-text-2.5 wrp-w-1/7 wrp-text-2.5 wrp-uppercase">
                      Transaction Status
                    </div>
                    <div className=" wrp-text-grayprimary wrp-font-bold xl:wrp-text-xs md:wrp-text-2.5 wrp-w-1/7 wrp-text-2.5 wrp-uppercase">
                      Receipient Wallet
                  ...
                  <div className="wrp-flex wrp-flex-col wrp-gap-4">
                    {payoutItems?.batch_payout_items.map(
                      (payout: payoutItemEachEntryProp, index: any) => {
                        return (
                          <Card
                            key={index}
                            className="wrp-flex wrp-justify-between wrp-p-4 !wrp-shadow-md wrp-h-18 wrp-items-center"
                          >
                            <div className="wrp-text-primary xl:wrp-text-sm wrp-font-bold lg:wrp-text-xs md:wrp-text-2.5  wrp-text-2.5 wrp-w-1/4 ">
                              #{payout.receiver_email}
                            </div>
                            <div className="wrp-text-primary xl:wrp-text-sm wrp-font-bold lg:wrp-text-xs md:wrp-text-2.5  wrp-text-2.5 wrp-w-1/6 ">
                              {payout.amount} {payout.currency_code}
                            </div>
                            <div className="wrp-w-1/7">
                              <Badge
                                className={`${payout.transaction_status != "SUCCESS" ? "wrp-bg-red-600 hover:wrp-bg-red-600" : "!wrp-bg-green-600 hover:wrp-bg-green-600"} `}
                              >
                                {payout.transaction_status}
                              </Badge>
                            </div>
                            <div className="wrp-text-primary xl:wrp-text-sm wrp-font-bold lg:wrp-text-xs md:wrp-text-2.5  wrp-text-2.5 wrp-w-1/7">
                              {payout.receipient_wallet
                                ? payout.receipient_wallet
                                : "-"}
                            </div>
                            <div className="wrp-text-primary xl:wrp-text-sm wrp-font-bold lg:wrp-text-xs md:wrp-text-2.5  wrp-text-2.5 wrp-w-1/7">
                ...
                <div className="wrp-flex wrp-justify-end wrp-items-center wrp-my-4">
                  <div className="pagination">
                    <Pagination
                      ...
                      pageCount={payoutItems?.total_pages || 1}
                      limit={payoutItems?.per_page || 5}
                      loading={false}
        ...
        <div className="wrp-h-[65vh] rwr-w-full wrp-flex">
